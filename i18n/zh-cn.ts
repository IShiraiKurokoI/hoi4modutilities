...
const table: Partial<typeof __table> = {
    ...
    "moddeps.nomodfile": "未选择工作模组定义文件。",
    "moddeps.context.openModFile": "打开模组文件",
    "moddeps.context.openModFolder": "打开模组文件夹",
    "moddeps.context.openSteamPage": "打开 Steam 页面",
    "moddeps.graph.basegame": "游戏本体",
    "moddeps.graph.vanilla": "原版",
    "moddeps.view.root": "工作模组依赖",
    "moddeps.view.unresolved": "未解析",
    "moddeps.graph.working": "工作模组",
    "mergedfiles.source.workspace": "工作区",
    "mergedfiles.source.vanilla": "原版",
