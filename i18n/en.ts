...
const internalTable = /* SOT Do not remove this comment */{
    ...
    "moddeps.nomodfile": "No working mod descriptor selected.",
    "moddeps.context.openModFile": "Open mod file",
    "moddeps.context.openModFolder": "Open mod folder",
    "moddeps.context.openSteamPage": "Open Steam page",
    "moddeps.graph.basegame": "Base game",
    "moddeps.graph.vanilla": "Vanilla",
    "moddeps.view.root": "Working mod dependencies",
    "moddeps.view.unresolved": "unresolved",
    "moddeps.graph.working": "Working mod",
    "mergedfiles.source.workspace": "Workspace",
    "mergedfiles.source.vanilla": "Vanilla",
